...
\includepdf[fitpaper=true, pages=-]{Partes/capa}
...
\begin{siglas}
  ...
  \acro{PPF}{Protein Prediction Framework}
  ...
  \acro{SaEA}{Self Adaptive Evolutionary Algorithm}
...
\begin{apendicesenv}
  \include{Partes/appendix-data-source}
  \include{Partes/appendix-tables-results}
  \include{Partes/appendix-shapiro}
  \include{Partes/appendix-mann-whitney-rmsd}
  \include{Partes/appendix-mann-whitney-energy}
  \include{Partes/appendix-convergence}
  \include{Partes/appendix-gdtts}
  \include{Partes/appendix-tmscore}
  \include{Partes/apeA}
\end{apendicesenv}
