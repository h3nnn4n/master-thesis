...
The proposed algorithms were implemented using the proposed \ac{RPPF}\footnote{Available at
\url{https://github.com/h3nnn4n/vai-ter-link-aqui-depois}}. Based on that, the
first method is named RPPF-MC and the second is named RPPF-REMC.
