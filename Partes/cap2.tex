...
\ac{EA} indicated wether the method is based on an Evolutionary Algorithm or not. The
majority of the methods are EA-based. Column \ac{FI} shows the use of fragment insertion
...
Column \ac{CC} considers the use of Conformational Clustering. Of the itens considered,
this one was the most scarse with only two occurences. Column KD indicated the use
...
\begin{table}
    ...
    Conformation Clusterting. KD means Knowledge Domain. A dash indicates that
