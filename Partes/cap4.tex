...
centroids, that has a more smooth energy landscape and is faste to evaluate. On
...
straight foward. The other, for the energy, is more complex. The energies before
and after the repacking are essentialy different units of measure. Therefore, a
...
in the restults. Firstly, both 1crn and 1enh had a increase of RMSD. While
relativelly small, specially for rosetta, it is interesting that it happened for
...
rosetta had an increase of RMSD for all the reimaining seven proteins. The
...
below $8$. Finally, the third noteworth aspect of the results is that the only
mean above $1$ was on 1rop for sade-remc-final, which had the worst performance
on that protein. This result could be explainer due to the method having poor
...
occurences, while for \texttt{score3} here are $3$.
...
Another performance analisys that can be made on top of the proposed methods,
...
One noteworth aspect of GDT-TS and TM-Score, is that they appear to be more
