...
\begin{fichacatalografica}
    \includepdf{Partes/ficha.pdf}
\end{fichacatalografica}

% ---
% Geração da Ficha Catalográfica Via LaTeX
% ---
%k\begin{fichacatalografica}
%k  \vspace*{\fill}					% Posição vertical
%k  \begin{center}					% Minipage Centralizado
%k    \begin{minipage}[c]{12.5cm}		% Largura
%k
%k      da Silva, Renan Samuel
%k
%k      \hspace{0.5cm} \imprimirtitulo  / \imprimirautor. --
%k      \imprimirlocal, \imprimirdata-
%k
%k      \hspace{0.5cm} \pageref{LastPage} p. : il. (algumas color.) ; 30 cm.\\
%k
%k      \hspace{0.5cm} Orientador: \imprimirorientadorRotulo~\imprimirorientador\\
%k
%k      \hspace{0.5cm}
%k      \parbox[t]{\textwidth}{Dissertação (mestrado) -- Universidade do Estado de Santa Catarina, Centro de Ciências Tecnológicas, Programa de Pós-Graduação em Computação Aplicada, Joinville, 2019}\\
%k
%k      \hspace{0.5cm}
%k      1. Monte Carlo.
%k      2. Inserção de fragmento.
%k      3. Problema de Predição de Estrutura de Proteínas.
%k      4. Controle de Parâmetros.
%k      5. Clusterização.
%k      I. Parpinelli, Rafael Stubs.
%k      II. Universidade do Estado de Santa Catarina.
%k      III. Centro de Ciências Tecnológicas.
%k      IV. Programa de Pós-Graduação em Computação Aplicada.
%k
%k      \hspace{8.75cm} CDU 02:121:005.7\\
%k
%k    \end{minipage}
%k  \end{center}
%k\end{fichacatalografica}
